        ...
        <AnimatePresence>
            <Wrapperstyle id="quote-box">
                ...
                <div className='interactions-wrapper'>
                    ...
                    <div>
                        <a rel="noopener noreferrer" target="_blank" onClick={updateQuote} id="new-quote"><MdRefresh /></a>
                    </div>
                </div>
                <div className='quote-wrapper'>
                    <div>
                        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Lasterminator"><p id='pageauthor'>{"By LasTerminator"}</p></a>
                    </div>
                </div>
            </Wrapperstyle>
        </AnimatePresence>
